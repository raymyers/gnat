...
///
////////////////////////////////////////////////////////////////////////////////
QString CTreeGraph::getFileName()
{
    return m_fileName;
}

////////////////////////////////////////////////////////////////////////////////
/// CTreeGraph::getRootNode
///
...
/// @post                 None
///
/// @return STreeNode *:  This is a pointer to the current root node of the
///                       tree.
///
/// @limitations          None
///
////////////////////////////////////////////////////////////////////////////////
STreeNode * CTreeGraph::getRootNode() const
{
    return m_rootNode;
}
...
///
////////////////////////////////////////////////////////////////////////////////
void CTreeGraph::load( const QString &fileName )
{
...
///
////////////////////////////////////////////////////////////////////////////////
void CTreeGraph::loadHelper( STreeNode *node, QDataStream &stream )
{
    ...
    for (int i = 0; i < size; i++)
    {
        ...
        node->s_childList.append( new STreeNode );
...
///
////////////////////////////////////////////////////////////////////////////////
void CTreeGraph::save( const QString &fileName )
{
    //Check that either the given filename or the one stored within the class
...
///
////////////////////////////////////////////////////////////////////////////////
void CTreeGraph::saveHelper( const STreeNode *node, QDataStream &stream )
{
...
///
////////////////////////////////////////////////////////////////////////////////
void CTreeGraph::setFileName( const QString &fileName )
{
    m_fileName = fileName;
}

////////////////////////////////////////////////////////////////////////////////
/// CPuzzleGraph::setRootNode
///
...
///
////////////////////////////////////////////////////////////////////////////////
void CTreeGraph::setRootNode( STreeNode *node )
{
    m_rootNode = node;
}
...
/// STreeNode::STreeNode
///
/// @description  This is the default constructor for the STreeNode struct.
...
/// STreeNode::~STreeNode
///
/// @description  This is the destructor for the STreeNode struct.  It frees
