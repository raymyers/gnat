...
////////////////////////////////////////////////////////////////////////////////
/// CTreeHistoryArtist::CTreeHistoryArtist
///
...
///
////////////////////////////////////////////////////////////////////////////////
CTreeHistoryArtist::CTreeHistoryArtist( QPaintDevice *canvas )
{
    m_canvas = canvas;
    m_model = NULL;
...
///
////////////////////////////////////////////////////////////////////////////////
QString CTreeHistoryArtist::moveName( const STreeNode* node )
{
    if( node == NULL )
        return QString();
...
///
////////////////////////////////////////////////////////////////////////////////
void CTreeHistoryArtist::paintTable( QPainter *painter )
{
...
///
////////////////////////////////////////////////////////////////////////////////
void CTreeHistoryArtist::setModel( CTreeGraphModel *model )
{
    m_model = model;
}
